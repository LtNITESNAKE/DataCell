...
struct AuthenticatedUser {//done
	int index=0;
	string role;
};


DataCell inDataCell()//done
{
	DataCell dataCell;
...
void generateTranscript(DataCell& department, int index)//DONE
{
